...
| Active maintenance | Moderate | CI, Dependabot, weekly version PR, and tri-daily maintenance workflow help. |
...
- stop or reduce frequency after the June 3 application
